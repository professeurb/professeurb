---
title: 'Résolution de puzzle avec Z3'
...
1. Chaque case non vide contient un nombre compris entre `py§1` et `py§9`. Il est très pratique de supposer de plus qu'une case vide contient le nombre&nbsp;`py§0`.
