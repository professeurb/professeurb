...
C'est cet algorithme – Introsort avec finition en tri par insertion – qui est (avec des tonnes d'optimisations supplémentaires) utilisé dans la bibliothèque standard de C++.
