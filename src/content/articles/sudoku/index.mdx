...
Dans la phase de résolution, on travaillera donc sur la liste <Py text="cases"/> plutôt que de chercher quelle est la case suivante. La fonction `py§essaye_case` devient alors&nbsp;:
